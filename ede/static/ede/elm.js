...
var _user$project$Search$Tweet = F4(
	function (a, b, c, d) {
		return {content: a, searchString: b, authorUrl: c, authorName: d};
	});
var _user$project$Search$tweetDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$Search$Tweet,
	A2(
		_elm_lang$core$Json_Decode$at,
		{
			ctor: '::',
	...
	A2(
		...
		_elm_lang$core$Json_Decode$string));
var _user$project$Search$tweetsDecoder = A2(
	_elm_lang$core$Json_Decode$at,
	{
		ctor: '::',
		_0: 'tweets',
...
var _user$project$Search$GotTweets = function (a) {
	return {ctor: 'GotTweets', _0: a};
};
var _user$project$Search$getTweets = function () {
	var url = '/search-tweets.json';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Search$GotTweets,
